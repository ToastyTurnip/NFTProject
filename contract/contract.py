...
class AdLotNFT(
    ...
    def __init__(self, admin, metadata,
        ...
        Fa2Nft.__init__(self, metadata, token_metadata=token_metadata, ledger=ledger, policy=policy, metadata_base=metadata_base)
    ...
    def mint(self, batch):
        '''
        This function is called by an admin (self), and the input is a TRecord consisting of
        to_ : the address of the recipient of the NFT
        metadata: a TString -> TBytes TMap consisting of
            x_coord (the x-coordinate of the top left corner of the rectangle), 
            y_coord (the y-coordinate of the top left corner of the rectangle), 
            width (the width of the rectangle), 
            height (the height of the rectangle), 
            owner_title (interpreted as a series of ASCII values),
            description (interpreted as an offsite link to a description), 
            image_url (interpreted as an offsite link to an image)
        '''
        sp.set_type(
            batch,
            sp.TRecord(
